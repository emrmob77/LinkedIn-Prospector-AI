...
- **Data Collection**: Chrome Extension for LinkedIn data capture
...
- `POST /api/search/run`: LinkedIn tarama işini başlatır (Apify - opsiyonel)
...
7. Her gönderi için AI sınıflandırma işi kuyruğa alınır
8. AI Engine ilgiliği sınıflandırır ve potansiyel müşterileri çıkarır
